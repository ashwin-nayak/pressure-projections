...
"""
# Plot from fem order 2
orderFE = 2

# Load variables from JDL2 file
using JLD2
file = "results/CPUtime_data_from_fem_k=50_orderFE=2_orderFEpostprocessing=2.jld2"
vars = load(file)
k = vars["k"]
...
# Error u
#scatterlines!(2*pi/k.*N_values, CPUtime_u[:,1], color = :black, label = L"$\mathbf{u}_{h,\mathrm{RT}_{1}}$", marker = '△', markersize = 10)
...
# Error p
#scatterlines!(2*pi/k.*N_values, CPUtime_p[:,1], color = :green, label = L"$p_{h,\mathrm{CG}_{2}}$", marker = '◇', markersize = 10)
...
scatterlines!(2*pi/k.*N_values, CPUtime_proj_DG[:,1], color = :orange, label = L"$\Pi_{h,\mathrm{DG}_{1}}^{\mathrm{L}^2}$", marker = '▷', markersize = 10)
...
scatterlines!(2*pi/k.*N_values, CPUtime_proj_CG[:,1], color = :blue, label = L"$\Pi_{h,\mathrm{CG}_{2}}^{\mathrm{L}^2}$", marker = '□', markersize = 10)
...
scatterlines!(2*pi/k.*N_values, CPUtime_proj_H1[:,1], color = :red, label = L"$\Pi_{h,\mathrm{CG}_{2}}^{\mathrm{H}^1}$", marker = '○', markersize = 10)
...
scatterlines!(2*pi/k.*N_values, CPUtime_proj_H2_DG[:,1], color = :purple, label = L"$\Pi_{h,\mathrm{DG}_{2}}^{\mathrm{H}^1}$", marker = '☆', markersize = 10)
...
#scatterlines!(2*pi/k.*N_values, Memory_u[:,1]/1e6, color = :black, label = L"$\mathbf{u}_{h,\mathrm{RT}_{1}}$", marker = '△', markersize = 10)
#scatterlines!(2*pi/k.*N_values, Memory_p[:,1]/1e6, color = :green, label = L"$p_{h,\mathrm{CG}_{2}}$", marker = '◇', markersize = 10)
scatterlines!(2*pi/k.*N_values, Memory_proj_DG[:,1]/1e6, color = :orange, label = L"$\Pi_{h,\mathrm{DG}_{1}}^{\mathrm{L}^2}$", marker = '▷', markersize = 10)
scatterlines!(2*pi/k.*N_values, Memory_proj_CG[:,1]/1e6, color = :blue, label = L"$\Pi_{h,\mathrm{CG}_{2}}^{\mathrm{L}^2}$", marker = '□', markersize = 10)
scatterlines!(2*pi/k.*N_values, Memory_proj_H1[:,1]/1e6, color = :red, label = L"$\Pi_{h,\mathrm{CG}_{2}}^{\mathrm{H}^1}$", marker = '○', markersize = 10)
scatterlines!(2*pi/k.*N_values, Memory_proj_H2_DG[:,1]/1e6, color = :purple, label = L"$\Pi_{h,\mathrm{DG}_{2}}^{\mathrm{H}^1}$", marker = '☆', markersize = 10)
# axislegend(; position = :rb, nbanks = 1, framecolor = (:grey, 0.5))
Legend(fig[1, 2], ax, halign = :right, valign = :top, labelsize = 17, markersize = 10, markerstrokewidth = 0.5)
xlims!(ax, 2*pi/k.*N_values[end], 2*pi/k.*N_values[1])
ylims!(ax, 2e0, 7e3)
...
xticksize = 10, ytickalign = 1, yticksize = 10, xscale=log10, yscale=log10, # xticks = vcat([2*pi/k.*N_values[end]], 10 .^range(-3, stop=-1, length=3)), yticks = 10 .^range(-5, stop=2, length=8)
    ...
    xminorticksvisible = true, xminorgridvisible = true, xminorticks = IntervalsBetween(9))
# Memmory for u in MegaBytes
#scatterlines!(2*pi/k.*N_values, Memory_u[:,2], color = :black, label = L"$\mathbf{u}_{h,\mathrm{RT}_{1}}$", marker = '△', markersize = 10)
#scatterlines!(2*pi/k.*N_values, Memory_p[:,2], color = :green, label = L"$p_{h,\mathrm{CG}_{2}}$", marker = '◇', markersize = 10)
scatterlines!(2*pi/k.*N_values, Memory_proj_DG[:,2], color = :orange, label = L"$\Pi_{h,\mathrm{DG}_{1}}^{\mathrm{L}^2}$", marker = '▷', markersize = 10)
scatterlines!(2*pi/k.*N_values, Memory_proj_CG[:,2], color = :blue, label = L"$\Pi_{h,\mathrm{CG}_{2}}^{\mathrm{L}^2}$", marker = '□', markersize = 10)
scatterlines!(2*pi/k.*N_values, Memory_proj_H1[:,2], color = :red, label = L"$\Pi_{h,\mathrm{CG}_{2}}^{\mathrm{H}^1}$", marker = '○', markersize = 10)
scatterlines!(2*pi/k.*N_values, Memory_proj_H2_DG[:,2], color = :purple, label = L"$\Pi_{h,\mathrm{DG}_{2}}^{\mathrm{H}^1}$", marker = '☆', markersize = 10)
# axislegend(; position = :rb, nbanks = 1, framecolor = (:grey, 0.5))
Legend(fig[1, 2], ax, halign = :right, valign = :top, labelsize = 17, markersize = 10, markerstrokewidth = 0.5)
xlims!(ax, 2*pi/k.*N_values[end], 2*pi/k.*N_values[1])
